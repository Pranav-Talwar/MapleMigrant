    ...
    <html lang="en" className="h-full">
      <head>
        ...
        <link
          ...
          crossOrigin="anonymous"        /* fix: “anonymous” is a valid value */
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap"
          rel="stylesheet"
        />
        <title>MapleMigrant – Sign in</title>
        {/* Tailwind */}
      ...
      <body className="h-full bg-gradient-to-br from-[#FAFAFA] to-[#F4F6F8] relative flight-pattern flex items-center justify-center py-12 px-4">
        <main className="glass rounded-[24px] max-w-sm w-full p-8 relative">
          ...
          <div className="flex items-center justify-center mb-6">
           <FontAwesomeIcon
              ...
              style={{ color: '#c10007', fontSize: '33px' }} // ⬆️ enlarged icon
          ...
          <input
            ...
            className="w-full h-[52px] px-4 rounded-full border border-gray-300 focus:border-[#C8102E] focus:ring-[#C8102E]/40 mb-4"
          />
          ...
          <input
            ...
            type="password"
            placeholder="••••••••"
            className="w-full h-[52px] px-4 rounded-full border border-gray-300 focus:border-[#C8102E] focus:ring-[#C8102E]/40 mb-6"
          />
        ...
        <footer className="absolute bottom-4 left-1/2 -translate-x-1/2 text-[11px] text-gray-500">
          © 2025 MapleMigrant · Your compass in a new land.
        </footer>
      </body>
    </html>
  )
